...
try {
  ...
  if ((await health.text()) !== "next-ok") throw new Error("Next route unavailable");
  ...
  if ((await received).content !== "Hello through Next.js") throw new Error("Message delivery failed");
  alice.destroy();
  bob.destroy();
